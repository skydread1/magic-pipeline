            ...
            if(!method.IsStatic && method.DeclaringType.IsValueType)
            {
                if(method.ReturnType == typeof(void))
                {
                    ...
                    return (arg0,arg1,arg2,arg3,arg4,arg5,arg6,arg7,arg8,arg9) => {
                        var target = (T0)arg0;
                        f(ref target,(arg1 is T1 ? (T1)arg1 : (T1)Binder.Shared.ConvertArgument(typeof(T1), arg1)),(arg2 is T2 ? (T2)arg2 : (T2)Binder.Shared.ConvertArgument(typeof(T2), arg2)),(arg3 is T3 ? (T3)arg3 : (T3)Binder.Shared.ConvertArgument(typeof(T3), arg3)),(arg4 is T4 ? (T4)arg4 : (T4)Binder.Shared.ConvertArgument(typeof(T4), arg4)),(arg5 is T5 ? (T5)arg5 : (T5)Binder.Shared.ConvertArgument(typeof(T5), arg5)),(arg6 is T6 ? (T6)arg6 : (T6)Binder.Shared.ConvertArgument(typeof(T6), arg6)),(arg7 is T7 ? (T7)arg7 : (T7)Binder.Shared.ConvertArgument(typeof(T7), arg7)),(arg8 is T8 ? (T8)arg8 : (T8)Binder.Shared.ConvertArgument(typeof(T8), arg8)),(arg9 is T9 ? (T9)arg9 : (T9)Binder.Shared.ConvertArgument(typeof(T9), arg9)));
                        return null;
                    };
                }
                else
